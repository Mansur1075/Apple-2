...
const Bennar = () => {
    return (
        <div>
            <div
                className='bennar_1 h-125 md:h-162.5 text-white flex flex-col items-center justify-start pt-12 md:pt-16 w-full bg-black bg-no-repeat bg-bottom bg-size-[auto_75%] sm:bg-contain'
                style={{ backgroundImage: `url(${bennar})` }}
            >
                <div className="text-center font-sans px-4 mb-0">
