...
const Bennar = () => {
    ...
    <div className='bennar_1 bg-[#000000] text-white flex flex-col items-center pt-10 md:pt-16 pb-0 relative overflow-hidden w-full'>
        ...
        <div className="w-full max-w-[300px] sm:max-w-[500px] md:max-w-[800px] lg:max-w-[1000px] mt-6 md:mt-2 px-0 flex justify-center items-end">
            <img src={bennar} alt="" className="w-full h-auto object-contain block mx-auto"/>
        </div>
    </div>
</div>
    )
